...
{
	// basic items
	auto* item = AddItem("Chopsticks", SwordSprite, ItemTypes::Weapon);
	...
	item = AddItem("Yez Chicken", FoodSprite, ItemTypes::Activatable);
	...
	item = AddItem("Spatula", AxeSprite, ItemTypes::Weapon);
	item->Attack.MinDamage = 1;
	item->Attack.MaxDamage = 4;
	item->Attack.Cooldown = 1.5f;

	item = AddItem("Mighty Spatula", MightyAxeSprite, ItemTypes::Weapon);
	item->Attack.MinDamage = 2;
	item->Attack.MaxDamage = 7;
	item->Attack.Cooldown = 1.5f;

	item = AddItem("Knife", ForkSprite, ItemTypes::Weapon);
	item->Attack.MinDamage = 1;
	item->Attack.MaxDamage = 3;
	item->Attack.Range = 20;
	item->Attack.Cooldown = 0.5f;

	item = AddItem("Bread Machine", BowSprite, ItemTypes::Weapon);
	item->Attack.MinDamage = 1;
	item->Attack.MaxDamage = 3;
	...
	item = AddItem("Sweet Bread Machine", GoodBowSprite, ItemTypes::Weapon);
	...
	item = AddItem("Soup", PotionSprite, ItemTypes::Activatable);
	item->Effect = ActivatableEffects::Healing;
	item->Value = 20;
	...
	item = AddItem("Egg", FireballSprite, ItemTypes::Activatable);
